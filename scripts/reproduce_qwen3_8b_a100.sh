...
# Reproduce Qwen3-8B + vLLM + ThunderAgent + mini-SWE-agent SWE-bench Lite on single A100.
# Run this script from repository root.
#
# Usage:
#   bash scripts/reproduce_qwen3_8b_a100.sh [TASK_COUNT] [WORKERS]
#
# Arguments:
...
OUTPUT_DIR="results/qwen3_8b_lite_${TASK_COUNT}_${TIMESTAMP}"
...
main() {
  log_info "============================================"
  log_info "Qwen3-8B SWE-bench Lite reproduce"
